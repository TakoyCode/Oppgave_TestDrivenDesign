using Oppgave_TestDrivenDesign.Main;

namespace Oppgave_TestDrivenDesign.Test
{
    public class Tests
    {
        [Test]
        public void TestValidInitialization()
        {
            ...
            GameCharacter gameCharacter = new GameCharacter(100, 20, 40);
